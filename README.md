...
account. Then by simply navigating to https://colab.research.google.com/, upload the project and run all the cells. More notes on  how the code works are provided in the next section.
